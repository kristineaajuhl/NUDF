...
import numpy as np
import argparse
from models.PC_generation import Generator
from PC_generation_iterator import gen_iterator
...
if __name__ == '__main__':
    ...
    parser.add_argument('-std_dev','--sample_sigmas',default=[], nargs='+')
    ...
    dataset = voxelized_data.VoxelizedDataset(args.mode, input_type= args.input_type , pointcloud_samples= args.pc_samples, res=args.res, sample_distribution=args.sample_distribution,
